...
class actionGoiYHoiVeDH_LT_SDH(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        response = "Tôi có thông tin tuyển sinh, học phí, CTĐT:<br>- đại học chính quy<br>- liên thông<br>- sau đại học"
        # else:
...
class actionGoiYTuyenSinh(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        print("mảng role: ", role)
        if 'info' in role and 'thong_tin_tuyen_sinh' in role or 'thong_tin_tuyen_sinh' in role:
            response = "Tôi có thông tin tuyển sinh:<br>- đại học chính quy<br>- liên thông<br>- sau đại học"
        else:
            response = f"Bạn vui lòng mô tả thêm thông tin"
        dispatcher.utter_message(text=response)
...
class actionGoiYTuyenSinhDaiHoc(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        print("ACTION goi ý tuyển sinh đại học")
        entities = tracker.latest_message['entities']
        print(f"\nnEntity từ input : {entities}")
        ...
        if 'thong_tin_tuyen_sinh' in role and 'dai_hoc_chinh_quy' in role or 'dai_hoc_chinh_quy'in role:
        ...
        if 'thong_tin_tuyen_sinh' in role and 'lien_thong' in role or 'lien_thong' in role:
            response = f"<br>Thông tin tuyển sinh {slot_tuyensinh} gôm:<br>"
